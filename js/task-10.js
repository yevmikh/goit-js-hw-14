...
console.log(control, boxesContainer, createBoxNew, removeBoxNew);

createBoxNew.addEventListener("click", createBoxes);
removeBoxNew.addEventListener("click", destroyBoxes);
